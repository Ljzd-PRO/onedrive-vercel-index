...
export const showOpenFilePicker:(options?:OpenFilePickerOptions) => Promise<(FileSystemFileHandle | FileSystemDirectoryHandle)[]>;
export const showDirectoryPicker:(options?:StartingDirectory) => Promise<FileSystemDirectoryHandle>;
export const showSaveFilePicker:(options?:SaveFilePickerOptions) => Promise<FileSystemFileHandle>;
